  ...
  return (
    <div className="group flex w-[220px] shrink-0 flex-col items-center justify-center gap-4 px-4 py-2 transition-all duration-300">
      <img
        ...
        className="h-14 w-auto max-w-[160px] object-contain opacity-50 grayscale transition-all duration-300 group-hover:opacity-100 group-hover:grayscale-0"
      />
  ...
  return (
    <div className="bg-white pb-10 pt-10 lg:pb-16 lg:pt-16">
      ...
      <div className="mx-auto max-w-2xl px-6 text-center lg:px-10">
        ...
        <p className="mt-6 font-sans leading-relaxed text-steel-400">
